    ...
    return(
        ...
        <div className="employer_card">
          ...
          <ul className="employer_card_nets">
            <li className="employer_card_net_item"><a href="https://www.instagram.com/crossoverautos/" target="_blank" className="instagram Link"><FaInstagram className="insta"/></a></li>
            <li className="employer_card_net_item"><a href="https://api.whatsapp.com/send?phone=5511976316322&text=Olá%20Cross%20Over%20-%20Funilaria%20Express%20%20e%20Estética%20Automotiva%2C%20eu%20preciso%20de%20mais%20informações%20sobre%3A" target="_blank" className="Whats Link"><FaWhatsapp className="whats"/></a></li>
          </ul>
        </div>
        <div className="employer_card">
