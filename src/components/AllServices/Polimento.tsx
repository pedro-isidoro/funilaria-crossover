...
export const Polimento = () => {
    return(
        <section className="polimento_section">
            <div className="polimento_background">
                <h2>Polimento</h2>
            </div>
            <div className="polimento_text_section">
                ...
                <div className="polimento_second_text_section">
                ...
                <div className="polimento_third_text_section">
