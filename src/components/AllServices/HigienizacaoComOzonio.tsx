...
export const HigienizacaoComOzonio = () => {
    return(
        <section className="higienizacaoComOzonio_section">
            <div className="higienizacaoComOzonio_background">
                <h2>Higienização Com Ozônio</h2>
            </div>
            <div className="higienizacaoComOzonio_text_section">
                <div className="higienizacaoComOzonio_second_text_section">
