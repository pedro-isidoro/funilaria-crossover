  ...
  GsapFunction({triggerFather: ".services_list", trigger: ".services_list_service", markers: false, start: "top 750px", end: "bottom 500px"});
    return (
        ...
        <ul className="services_list">
          ...
          <li className="services_list_service"><img src="/images/services/pistola-de-pintura.webp" alt="paint gun icon" className="carIcon2"/><p>Micro<br/>Retoque</p><Link to={"/servicos/micro-pintura"} className="link_know_more">Clique aqui!</Link></li>
