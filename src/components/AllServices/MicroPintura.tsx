...
export const MicroPintura = () => {
    return (
        <section className="microPintura_section">
            <div className="microPintura_background">
                <h2>Micro Pintura</h2>
            </div>
            <div className="microPintura_text_section">
                ...
                <div className="microPintura_second_text_section">
                ...
                <div className="microPintura_third_text_section">
